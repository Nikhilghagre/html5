        ...
        if(isset($_POST['profile_section']))
        {
            switch ($_POST['profile_section']) {
                ...
                case "change_password_settings":
                    $this->form_validation->set_rules('old_password', $this->lang->line("Old Password"), 'trim|required|xss_clean|min_length[6]',
                        array(
                            'required'      => $this->lang->line("field_is_required"),
                            'min_length'      => $this->lang->line("must_be_minimum_characters")
                        ));
                    $this->form_validation->set_rules('new_password', $this->lang->line("New Password"), 'trim|required|xss_clean|min_length[6]',
                        array(
                            'required'      => $this->lang->line("field_is_required"),
                            'min_length'      => $this->lang->line("must_be_minimum_characters")
                        ));
    ...
    public function show_user()
    {
        if(isset($_POST['profile_section']) AND $_POST['profile_section'] == "profile_settings") {
            if(isset($_POST['user_firstname']))
            {
                ...
                $this->form_validation->set_rules('user_password', $this->lang->line("Password"), 'trim|xss_clean|min_length[6]',
                    array(
                        'required'      => $this->lang->line("field_is_required"),
                        'min_length'      => $this->lang->line("must_be_minimum_characters")
                    ));
