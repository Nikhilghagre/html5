...
class Settings extends Admin_Controller
{
        ...
        if(isset($_POST['setting_section']))
        {
            switch ($_POST['setting_section']) {
                case "configuration":
                    ...
                    $this->form_validation->set_rules('setting_recaptcha_protection', 'setting_recaptcha_protection', 'trim|xss_clean');
                    ...
                    if ($this->form_validation->run() == FALSE) {
                        ...
                        if($this->input->post('setting_recaptcha_protection') == "on") $setting_recaptcha_protection = "1"; else $setting_recaptcha_protection = "0";
                        ...
                        if ($new_setting_logo == "logo.png") {
                            $dataArray = array(
                                ...
                                "setting_recaptcha_protection" => $setting_recaptcha_protection,
                ...
                case "push_notification":
                    ...
                    if ($this->form_validation->run() == FALSE) {
                        ...
                        $dataArray = array(
							...
							"setting_one_signal_app_id" => $this->input->post('setting_one_signal_app_id'),
							"setting_one_signal_rest_api_key" => $this->input->post('setting_one_signal_rest_api_key'),
                        );
                        //Update from $dataArray
                        $this->Common_model->data_update("setting_table",$dataArray,array("setting_id"=>1));
                        $msg = $this->lang->line("Data successfully updated.");
    ...
    public function admob_settings()
    {
        if(isset($_POST['admob_setting_app_id']))
        {
			...
			$this->form_validation->set_rules('admob_setting_rewarded_unit_id', 'admob_setting_rewarded_unit_id', 'trim|required|xss_clean');
			$this->form_validation->set_rules('admob_setting_rewarded_status', 'admob_setting_rewarded_status', 'trim|xss_clean');
			$this->form_validation->set_rules('admob_setting_native_advanced_unit_id', 'admob_setting_native_advanced_unit_id', 'trim|required|xss_clean');
			$this->form_validation->set_rules('admob_setting_native_advanced_status', 'admob_setting_native_advanced_status', 'trim|xss_clean');
            ...
            if ($this->form_validation->run() == FALSE) {
				...
				if ($this->input->post('admob_setting_rewarded_status') == 'on') $admob_setting_rewarded_status = 1; else $admob_setting_rewarded_status = 0;
				if ($this->input->post('admob_setting_native_advanced_status') == 'on') $admob_setting_native_advanced_status = 1; else $admob_setting_native_advanced_status = 0;
                ...
                $dataArray = array(
					...
					"admob_setting_rewarded_unit_id" => $this->input->post('admob_setting_rewarded_unit_id'),
                    "admob_setting_rewarded_status" => $admob_setting_rewarded_status,
					"admob_setting_native_advanced_unit_id" => $this->input->post('admob_setting_native_advanced_unit_id'),
                    "admob_setting_native_advanced_status" => $admob_setting_native_advanced_status,
                );
                //Update from $dataArray
    ...
    public function email_settings()
    {
        if(isset($_POST['email_setting_mailtype']))
        {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $dataArray = array(
                    ...
                    "email_setting_smtppass" => $this->input->post('email_setting_smtppass'),
        ...
        $data["pageTitle"] = $this->lang->line("Email Settings");
    ...
    public function api_key()
    {
        if(isset($_POST['api_key']))
        {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $encode_api_key = convert_uuencode(strrev(base64_encode($api_key)));
                $dataArray = array(
