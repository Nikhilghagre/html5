                    ...
                    <div class="col-lg-12 d-flex">
                        <div class="content_box">
                            <ul class="bread_crumb text-center">
                                <li class="bread_crumb-item"><a href="<?php echo base_url(); ?>"><?php echo $this->lang->line("Home"); ?></a></li>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="blog_details_content <?php if ($this->lang->line("app_direction") == "rtl") echo "rtl"; ?>">
                                        ...
                                        <div class="owl-carousel one_items">
                                            <div class="image">
                                                ...
                                                <?php
													...
													else if ($contentDetail->content_player_type_id == 7) {
                                                        //echo "HLS ExoPlayer";
														?>
														<video id="my_video_1" class="video-js vjs-fluid vjs-default-skin" controls preload="auto" data-setup='{}'>
															<source src="<?php echo $contentDetail->content_url; ?>" type="application/x-mpegURL">
														</video>
                            ...
                            <ul class="tags_upper">
								...
								?>
								<li><a class="date" style="cursor: pointer" onclick="event.preventDefault(); document.getElementById('add-to-bookmark-form').submit();"><span class="fa fa-bookmark-o"></span> <?= $this->lang->line("Add To Bookmark") ?></a></li>
								<?php
								}elseif($isBookmarked == 1 AND $user_id != 0){
								?>
								<li><a class="date" style="cursor: pointer" onclick="event.preventDefault(); document.getElementById('remove-from-bookmark-form').submit();"><span class="fa fa-bookmark"></span> <?= $this->lang->line("Remove From Bookmark") ?></a></li>
								<?php
								}
								?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group texta">
                                                        <label><?php echo $this->lang->line("Your Comment2"); ?></label>
