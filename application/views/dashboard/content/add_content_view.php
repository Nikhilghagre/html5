                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    <label for="content_featured" class="col-sm-2 control-label"><?php echo $this->lang->line("Featured2"); ?></label>
                                    <div class="col-sm-10">
                                        <div class="form-line">
                                ...
                                <div class="form-group">
                                    <label for="content_special" class="col-sm-2 control-label"><?php echo $this->lang->line("Special2"); ?></label>
                                    <div class="col-sm-10">
                                        <div class="form-line">
