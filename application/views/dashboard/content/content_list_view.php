            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <?php echo $this->lang->line("Content List2"); ?>
                            </h2>
                                ...
                                <div class="table-responsive">
                                    <table id="pagesList" class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td><img class="img-rounded" alt="Image" width="80px" height="52px" src="<?php echo base_url()."assets/upload/content/thumbnail/$key->content_image" ?>"></td>
