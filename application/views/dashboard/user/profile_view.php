                ...
                <div class="card profile-card">
                    ...
                    <div class="profile-footer">
                        <ul>
                            ...
                            <li>
                                <span><?php echo $this->lang->line("Register From2"); ?></span>
                                ...
                                <div role="tabpanel" class="tab-pane fade in" id="change_password_settings">
                                    ...
                                    <form class="form-horizontal" method="post" action="<?php echo base_url()."dashboard/User/profile/" ?>">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-line">
                                                    <input type="password" class="form-control" name="old_password" minlength="6" maxlength="30" placeholder="<?php echo $this->lang->line("Old Password"); ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
											...
											<div class="col-sm-10">
												<div class="form-line">
													<select class="form-control show-tick" id="withdrawal_account_type" name="withdrawal_account_type" data-live-search="false" required>
														...
														{
														?>
															<option value="<?php echo $key->withdrawal_account_type_title; ?>"><?php echo $key->withdrawal_account_type_title; ?></option>
															<?php
														}
														?>
													</select>
