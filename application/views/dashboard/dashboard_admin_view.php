...
<section class="content">
    <div class="container-fluid">
        ...
        <?php } ?>
		<?php
		//echo "Purchase Code: ".config_item('purchase_code')."<br>";
		//echo "Site Key: ".$this->config->item('google_recaptcha_site_key')." | ". config_item('google_recaptcha_site_key')." | ";
		//echo "Secret Key: ".$this->config->item('google_recaptcha_secret_key');
		?>
        ...
        <div class="row clearfix">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" onclick="window.location.href='<?php echo base_url()."dashboard/Category/categories"; ?>';">
                <div class="info-box bg-deep-orange hover-zoom-effect">
                    ...
                    <div class="content">
                        <div class="text"><?php echo $this->lang->line("Categories2"); ?></div>
