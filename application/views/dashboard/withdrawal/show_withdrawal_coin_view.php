            ...
            <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        echo form_open_multipart(base_url()."dashboard/Withdrawal/show_withdrawal_coin/", $attributes);
                        ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="form-line" style="background-color: #e5e5e5">
                                    <input type="text" readonly="readonly" disabled class="form-control" name="withdrawal_account_type" placeholder="<?php echo $this->lang->line("Account Type"); ?>" value="<?php echo $withdrawalCoinContent->withdrawal_account_type; ?>" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="withdrawal_transaction" placeholder="<?php echo $this->lang->line("Transaction"); ?>" value="<?php echo $withdrawalCoinContent->withdrawal_transaction; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="form-line">
                                    <textarea class="form-control" rows="4" name="withdrawal_admin_comment" id="withdrawal_admin_comment"><?php echo $withdrawalCoinContent->withdrawal_admin_comment; ?></textarea>
                                </div>
                            </div>
                        </div>
