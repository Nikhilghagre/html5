                                ...
                                <div class="table-responsive">
                                    <table id="pagesList" class="table table-striped dataTable">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $key->withdrawal_account_type; ?></td>
                                                ...
                                                <div class="demo-button-toolbar clearfix">
                                                    <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                                        <div class="btn-group" role="group" aria-label="First group">
                                                            ...
                                                            <a href="#" data-toggle="modal" data-target="#deleteModal" data-id="<?php echo $key->withdrawal_id; ?>" type="button" class="identifyingClass btn btn-xs btn-danger waves-effect">&nbsp;<i class="material-icons" style="font-size: 18px">cancel</i>&nbsp;</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer" style="text-align: center">
                        ...
                        echo form_open(base_url()."dashboard/Withdrawal/delete_withdrawal_coin/", $attributes);
                        ?>
                        <input type="hidden" readonly="readonly" name="withdrawal_id" id="withdrawal_id" value="" required/>
    ...
    $(document).ready(function () {
        $('#pagesList').DataTable({
            ...
            "columnDefs": [
                ...
                { "targets": 1, "name": "user", 'searchable':true, 'orderable':true},
                { "targets": 2, "name": "account_type", 'searchable':true, 'orderable':true},
                { "targets": 3, "name": "coin", 'searchable':true, 'orderable':true},
                { "targets": 4, "name": "cash", 'searchable':true, 'orderable':true},
                { "targets": 5, "name": "time", 'searchable':true, 'orderable':true},
                { "targets": 6, "name": "status", 'searchable':true, 'orderable':true},
                { "targets": 7, "name": "action", 'searchable':false, 'orderable':false,'width':'110px'},
            ],
            "language": {
                paginate: {
...
<script type="text/javascript">
    $(function () {
        $(".identifyingClass").click(function () {
            ...
            $(".modal-footer #withdrawal_id").val(my_id_value);
        })
    });
</script>
