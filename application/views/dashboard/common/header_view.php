...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header <?php echo $this->lang->line("navbar-left"); ?>">
            ...
            <a class="navbar-brand" href="<?php echo base_url()."dashboard/Dashboard" ?>"><?php echo "ooltahchasmaplay"; ?></a>
        </div>
        <div class="collapse navbar-collapse" id="navbar-collapse">
            <ul class="<?php echo $this->lang->line("pull-right"); ?> nav navbar-nav navbar-right" style="<?php if($this->lang->line("app_direction") == "rtl") echo "margin-left: -55px;"; else echo "margin-left: 40px;"; ?>">
                ...
                <li class="dropdown <?php echo $this->lang->line("pull-left"); ?>">
                    ...
                    <ul class="dropdown-menu <?php echo $this->lang->line("pull-left"); ?>" style="max-height: 156px;">
                        ...
                        <li class="body">
                            <ul class="menu">
								...
								<li>
                                    <a href="<?php echo base_url()."LangSwitch/switchDashboardLanguage/hindi"; ?>">
                                        <img width="26px" height="26px" src="<?php echo base_url()."assets/dashboard/images/language-flag/india.png" ?>">
                                        <div class="menu-info">
                                            <h4><?php echo $this->lang->line("language_india"); ?></h4>
                                        </div>
                                    </a>
                                </li>
