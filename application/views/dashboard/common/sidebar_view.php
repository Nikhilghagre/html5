    ...
    <ul class="list">
        ...
        <li class="<?php if ($last_segment == "categories") echo $active_menu; ?>">
            <a href="<?php echo base_url()."dashboard/Category/categories"; ?>">
                ...
                <span><?php echo $this->lang->line("Categories2"); ?></span>
            </a>
        </li>
		...
		<!-- Withdrawal Coin -->
		<li class="<?php if ($last_segment == "withdrawal_accounts" or $last_segment == "edit_withdrawal_account") echo $active_menu; ?>">
			<a href="<?php echo base_url()."dashboard/Withdrawal/withdrawal_accounts"; ?>">
				<i class="material-icons">account_balance_wallet</i>
				<span><?php echo $this->lang->line("Withdrawal Accounts"); ?></span>
			</a>
		</li>
        ...
        <!-- User Manual -->
        <!-- <li class="">
            <a target="_blank" href="http://www.inw24.com/user_manual/game_station_pro/">
                <i class="material-icons">live_help</i>
                <span><?php echo $this->lang->line("Online User Manual"); ?></span>
            </a>
        </li> -->
...
<div class="legal" style="direction: <?php echo $this->lang->line("app_direction"); ?>">
    <div class="copyright">
        &copy; <?php if ($this->lang->line("date-format") == "default") echo mdate('%Y'); elseif($this->lang->line("date-format") == "jdf") echo $this->jdf->jdate('Y'); else echo mdate('%Y'); ?> <a target="_blank" href="<?php echo "http://www.inw24.com" ?>"><?php echo "ooltahchasmaplay.com" ?></a>.
    </div>
    <div class="version">
