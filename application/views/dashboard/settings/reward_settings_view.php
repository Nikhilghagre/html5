                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <p class="col-grey"><?php echo $this->lang->line("Expiration Time 3600 = 1 Hour"); ?></p>
								...
								<div class="form-group">
                                    <label for="reward_coin_rewarded_ad_exp" class="col-sm-4 control-label"><?php echo $this->lang->line("Rewarded Ads Expiration"); ?> *</label>
                                    <div class="col-sm-8">
                                        <div class="form-line">
                                            <input type="text" required class="form-control" name="reward_coin_rewarded_ad_exp" placeholder="<?php echo $this->lang->line("Interstitial Ads Expiration"); ?>" value="<?php echo $rewardSettingContent->reward_coin_rewarded_ad_exp; ?>">
                                        </div>
                                    </div>
                                </div>
							...
							<div class="form-group">
                                <label for="reward_coin_rewarded_ad_click" class="col-sm-4 control-label"><?php echo $this->lang->line("Rewarded Ads Reward Coin Per Watch Video"); ?> *</label>
                                <div class="col-sm-8">
                                    <div class="form-line">
                                        <input type="text" required class="form-control" name="reward_coin_rewarded_ad_click" placeholder="<?php echo $this->lang->line("Rewarded Ads Reward Coin Per Watch Video"); ?>" value="<?php echo $rewardSettingContent->reward_coin_rewarded_ad_click; ?>">
                                    </div>
                                    <small class="col-pink"><?php echo $this->lang->line("Set 0 to disable."); ?></small>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-4 col-sm-8">
                                        ...
                                        <input type="hidden" readonly required name="reward_coin_banner_ad_exp" value="21600">
                                        <input type="hidden" readonly required name="reward_coin_interstitial_ad_exp" value="21600">
                                        <input type="hidden" readonly required name="reward_coin_banner_ad_click" value="0">
                                        <input type="hidden" readonly required name="reward_coin_interstitial_ad_click" value="0">
