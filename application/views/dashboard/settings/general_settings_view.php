                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="body">
                                                <form class="form-horizontal" method="post" action="<?php echo base_url()."dashboard/Settings/general_settings/" ?>" enctype="multipart/form-data">
													...
													<?php
													$setting_recaptcha_protection_checked = "";
													if ($settingContent->setting_recaptcha_protection == 1)
														$setting_recaptcha_protection_checked = "checked";
													?>
													<div class="form-group">
														<label for="setting_recaptcha_protection" class="col-sm-2 control-label"><?php echo $this->lang->line("Enable reCAPTCHA"); ?></label>
														<div class="col-sm-10">
															<div class="form-line">
																<input type="checkbox" class="filled-in <?php echo $this->lang->line("chk-col-x"); ?>" <?php echo $setting_recaptcha_protection_checked; ?> id="setting_recaptcha_protection" name="setting_recaptcha_protection">
																<label for="setting_recaptcha_protection"><?php echo $this->lang->line("Enable Google reCAPTCHA protection."); ?></label>
															</div>
														</div>
													</div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
															...
															<small class="col-pink"><?php echo $this->lang->line("Logo should be 1120 x 363 pixels."); ?></small>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="body">
                                                <form class="form-horizontal" method="post" action="<?php echo base_url()."dashboard/Settings/general_settings/" ?>" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <div class="form-line">
                                                                <input type="password" class="form-control" name="setting_one_signal_app_id" required placeholder="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" value="<?php echo $settingContent->setting_one_signal_app_id; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <div class="form-line">
                                                                <input type="password" class="form-control" name="setting_one_signal_rest_api_key" required placeholder="NzxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxTp" value="<?php echo $settingContent->setting_one_signal_rest_api_key; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <form class="form-horizontal" method="post" action="<?php echo base_url()."dashboard/Settings/general_settings/" ?>" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            <small class="col-pink"><?php echo $this->lang->line("How to Get API Key for YouTube?"); ?> <a target="_blank" title="YouTube API" href="https://www.viacoders.com/how-to-get-api-key-for-youtube/"><?php echo $this->lang->line("Click Here!"); ?></a></small>
                                                        </div>
                                                    </div>
