                        ...
                        <div class="body">
                            ...
                            <!--<form class="form-horizontal" method="post" action="<?php echo base_url()."dashboard/Setting/email_settings/" ?>" enctype="multipart/form-data">-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="password" class="form-control" name="email_setting_smtppass" value="<?php echo $emailSettingContent->email_setting_smtppass; //echo $this->encrypt->decode($emailSettingContent->email_setting_smtppass); ?>">
                                        </div>
                                    </div>
                                </div>
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-9">
										<input type="hidden"  name="email_setting_mailtype" value="mail">
										<input type="hidden"  name="email_setting_smtphost" value="mail.domain.com">
										<input type="hidden"  name="email_setting_smtpuser" value="smtpuser">
										<input type="hidden"  name="email_setting_smtppass" value="smtppass">
										<input type="hidden"  name="email_setting_smtpport" value="21">
										<input type="hidden"  name="email_setting_crypto" value="none">
