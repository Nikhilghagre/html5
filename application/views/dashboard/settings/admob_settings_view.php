                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <!--<form class="form-horizontal" method="post" action="<?php echo base_url()."dashboard/Setting/email_settings/" ?>" enctype="multipart/form-data">-->
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
										...
										<small class="col-pink"><?php echo $this->lang->line("Add your AdMob app ID to your apps AndroidManifest.xml too"); ?></small>
                                    </div>
                                </div>
                            ...
                            <hr>
                                ...
                                <div class="form-group">
                                    <label for="admob_setting_rewarded_unit_id" class="col-sm-3 control-label"><?php echo $this->lang->line("Rewarded ID"); ?> *</label>
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="text" required class="form-control" name="admob_setting_rewarded_unit_id" placeholder="<?php echo $this->lang->line("AdMob Rewarded Unit ID"); ?>" value="<?php echo $admobSettingContent->admob_setting_rewarded_unit_id; ?>">
                                        </div>
                                    </div>
                                </div>
								
								<?php
                                $admob_setting_rewarded_status_checked = "";
                                if ($admobSettingContent->admob_setting_rewarded_status == 1)
                                    $admob_setting_rewarded_status_checked = "checked";
                                ?>
                                <div class="form-group">
                                    <label for="admob_setting_rewarded_status" class="col-sm-3 control-label"><?php echo $this->lang->line("Status"); ?></label>
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="checkbox" class="filled-in <?php echo $this->lang->line("chk-col-x"); ?>" id="admob_setting_rewarded_status" name="admob_setting_rewarded_status" <?php echo $admob_setting_rewarded_status_checked; ?>>
                                            <label for="admob_setting_rewarded_status"><?php echo $this->lang->line("Enable rewarded ad."); ?></label>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="form-group">
									<label for="admob_setting_native_advanced_unit_id" class="col-sm-3 control-label"><?php echo $this->lang->line("Native ID"); ?> *</label>
									<div class="col-sm-9">
										<div class="form-line">
											<input type="text" required class="form-control" name="admob_setting_native_advanced_unit_id" placeholder="<?php echo $this->lang->line("AdMob Native Unit ID"); ?>" value="<?php echo $admobSettingContent->admob_setting_native_advanced_unit_id; ?>">
										</div>
									</div>
								</div>

								<?php
								$admob_setting_native_advanced_status_checked = "";
								if ($admobSettingContent->admob_setting_native_advanced_status == 1)
									$admob_setting_native_advanced_status_checked = "checked";
								?>
								<div class="form-group">
									<label for="admob_setting_native_advanced_status" class="col-sm-3 control-label"><?php echo $this->lang->line("Status"); ?></label>
									<div class="col-sm-9">
										<div class="form-line">
											<input type="checkbox" class="filled-in <?php echo $this->lang->line("chk-col-x"); ?>" id="admob_setting_native_advanced_status" name="admob_setting_native_advanced_status" <?php echo $admob_setting_native_advanced_status_checked; ?>>
											<label for="admob_setting_native_advanced_status"><?php echo $this->lang->line("Enable native ad."); ?></label>
										</div>
									</div>
								</div>
