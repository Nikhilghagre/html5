...
$settingContent = $this->db->get_where('setting_table', array('setting_id'=>1))->result()[0];
?>

    <body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);"><?php echo "ooltahchasmaplay"; ?></a>
            <!-- <small><?php echo "ooltahchasmaplay"; ?></small> -->
            <br>
        ...
        <div class="card">
            <div class="body">
                ...
                if($settingContent->setting_recaptcha_protection == 0)
					echo form_open(base_url()."dashboard/Auth/user_login_process_without_google_recaptcha/", $attributes);
                else
				...
				{
                ?>
                <div class="g-recaptcha" data-sitekey="<?php echo config_item('google_recaptcha_site_key'); ?>"></div><br>
				<?php
				}
				?>
                <!--<div class="col-md-7">
